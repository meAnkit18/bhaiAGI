...
Use this folder for locale-specific translation guidance that supplements `.bhaiagi/agent/translator.md`.
...
- PR #12345: https://github.com/anomalyco/bhaiagi/pull/12345

## Do Not Translate (Locale Additions)

- `bhaiagi` (preserve casing)
