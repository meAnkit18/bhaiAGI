import type * as SDK from "@bhaiagi/sdk/v2"
...
const disabled = process.env["BHAIAGI_DISABLE_SHARE"] === "true" || process.env["BHAIAGI_DISABLE_SHARE"] === "1"
...
export class Service extends Context.Service<Service, Interface>()("@bhaiagi/ShareNext") {}
