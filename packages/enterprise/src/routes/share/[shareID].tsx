import { Message, Model, Part, Session, SessionStatus, SnapshotFileDiff, UserMessage } from "@bhaiagi/sdk/v2"
import { SessionTurn } from "@bhaiagi/ui/session-turn"
import { SessionReview } from "@bhaiagi/ui/session-review"
import { DataProvider } from "@bhaiagi/ui/context"
import { FileComponentProvider } from "@bhaiagi/ui/context/file"
import { WorkerPoolProvider } from "@bhaiagi/ui/context/worker-pool"
import { createAsync, query, useParams } from "@solidjs/router"
import { createMemo, createSignal, ErrorBoundary, For, Match, Show, Switch } from "solid-js"
import { Share } from "~/core/share"
import { Logo, Mark } from "@bhaiagi/ui/logo"
import { IconButton } from "@bhaiagi/ui/icon-button"
import { ProviderIcon } from "@bhaiagi/ui/provider-icon"
import { iife } from "@bhaiagi/shared/util/iife"
import { Binary } from "@bhaiagi/shared/util/binary"
import { NamedError } from "@bhaiagi/shared/util/error"
import { DateTime } from "luxon"
import { createStore } from "solid-js/store"
import z from "zod"
import NotFound from "../[...404]"
import { Tabs } from "@bhaiagi/ui/tabs"
import { MessageNav } from "@bhaiagi/ui/message-nav"
import { FileSSR } from "@bhaiagi/ui/file-ssr"
...
const ClientOnlyWorkerPoolProvider = clientOnly(() =>
  import("@bhaiagi/ui/pierre/worker").then((m) => ({
