export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller leveret af bhaiAGI",
  ...
  "provider.connect.apiKey.description":
    "Indtast din {{provider}} API-nøgle for at forbinde din konto og bruge {{provider}} modeller i bhaiAGI.",
  ...
  "provider.connect.opencodeZen.line1":
    "bhaiAGI Zen giver dig adgang til et udvalg af pålidelige optimerede modeller til kodningsagenter.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " for at hente din godkendelseskode for at forbinde din konto og bruge {{provider}} modeller i bhaiAGI.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og indtast koden nedenfor for at forbinde din konto og bruge {{provider}} modeller i bhaiAGI.",
  ...
  "dialog.server.description": "Skift hvilken bhaiAGI-server denne app forbinder til.",
  ...
  "toast.update.description": "En ny version af bhaiAGI ({{version}}) er nu tilgængelig til installation.",
  ...
  "error.page.report.prefix": "Rapporter venligst denne fejl til bhaiAGI-teamet",
  ...
  "error.chain.mcpFailed": 'MCP-server "{{name}}" fejlede. Bemærk, bhaiAGI understøtter ikke MCP-godkendelse endnu.',
  ...
  "sidebar.gettingStarted.line1": "bhaiAGI inkluderer gratis modeller så du kan starte med det samme.",
  ...
  "settings.desktop.wsl.description": "Kør bhaiAGI-serveren inde i WSL på Windows.",
  ...
  "settings.general.row.language.description": "Ændr visningssproget for bhaiAGI",
  "settings.general.row.appearance.title": "Udseende",
  "settings.general.row.appearance.description": "Tilpas hvordan bhaiAGI ser ud på din enhed",
  "settings.general.row.colorScheme.title": "Farveskema",
  "settings.general.row.colorScheme.description": "Vælg om bhaiAGI følger systemets, lyst eller mørkt tema",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpas hvordan bhaiAGI er temabestemt.",
  ...
  "settings.updates.row.startup.description": "Tjek automatisk for opdateringer, når bhaiAGI starter",
  ...
  "settings.updates.toast.latest.description": "Du kører den nyeste version af bhaiAGI.",
