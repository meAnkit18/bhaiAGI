...
beforeAll(async () => {
  ...
  mock.module("@bhaiagi/ui/collapsible", () => ({
    Collapsible: {
      Trigger: (props: { children?: unknown }) => props.children,
      Content: (props: { children?: unknown }) => props.children,
    },
  }))
  mock.module("@bhaiagi/ui/file-icon", () => ({ FileIcon: () => null }))
  mock.module("@bhaiagi/ui/icon", () => ({ Icon: () => null }))
  mock.module("@bhaiagi/ui/tooltip", () => ({ Tooltip: (props: { children?: unknown }) => props.children }))
