...
# Package managers
npm i -g bhaiagi-ai@latest        # or bun/pnpm/yarn
scoop install bhaiagi             # Windows
choco install bhaiagi             # Windows
brew install anomalyco/tap/bhaiagi # macOS and Linux (recommended, always up to date)
brew install bhaiagi              # macOS and Linux (official brew formula, updated less)
sudo pacman -S bhaiagi            # Arch Linux (Stable)
paru -S bhaiagi-bin               # Arch Linux (Latest from AUR)
mise use -g bhaiagi               # Any OS
nix run nixpkgs#bhaiagi           # or github:anomalyco/bhaiagi for latest dev branch
```
...
bhaiagi ডেস্কটপ অ্যাপ্লিকেশন হিসেবেও উপলব্ধ। সরাসরি [রিলিজ পেজ](https://github.com/anomalyco/bhaiagi/releases) অথবা [bhaiagi.ai/download](https://bhaiagi.ai/download) থেকে ডাউনলোড করুন।
...
4. `$HOME/.bhaiagi/bin` - ডিফল্ট ফলব্যাক
...
bhaiagi এ দুটি বিল্ট-ইন এজেন্ট রয়েছে যা আপনি `Tab` কি(key) দিয়ে পরিবর্তন করতে পারবেন।
...
এজেন্টদের সম্পর্কে আরও জানুন: [docs](https://bhaiagi.ai/docs/agents)।

### ডকুমেন্টেশন (Documentation)

কিভাবে bhaiagi কনফিগার করবেন সে সম্পর্কে আরও তথ্যের জন্য, [**আমাদের ডকস দেখুন**](https://bhaiagi.ai/docs)।

### অবদান (Contributing)

আপনি যদি bhaiagi এ অবদান রাখতে চান, অনুগ্রহ করে একটি পুল রিকোয়েস্ট সাবমিট করার আগে আমাদের [কন্ট্রিবিউটিং ডকস](./CONTRIBUTING.md) পড়ে নিন।

### bhaiagi এর উপর বিল্ডিং (Building on bhaiagi)

আপনি যদি এমন প্রজেক্টে কাজ করেন যা bhaiagi এর সাথে সম্পর্কিত এবং প্রজেক্টের নামের অংশ হিসেবে "bhaiagi" ব্যবহার করেন, উদাহরণস্বরূপ "bhaiagi-dashboard" বা "bhaiagi-mobile", তবে দয়া করে আপনার README তে একটি নোট যোগ করে স্পষ্ট করুন যে এই প্রজেক্টটি bhaiagi দল দ্বারা তৈরি হয়নি এবং আমাদের সাথে এর কোনো সরাসরি সম্পর্ক নেই।
...
- ১০০% ওপেন সোর্স
- কোনো প্রোভাইডারের সাথে আবদ্ধ নয়। যদিও আমরা [bhaiagi Zen](https://bhaiagi.ai/zen) এর মাধ্যমে মডেলসমূহ ব্যবহারের পরামর্শ দিই, bhaiagi ক্লড (Claude), ওপেনএআই (OpenAI), গুগল (Google), অথবা লোকাল মডেলগুলোর সাথেও ব্যবহার করা যেতে পারে। যেমন যেমন মডেলগুলো উন্নত হবে, তাদের মধ্যকার পার্থক্য কমে আসবে এবং দামও কমবে, তাই প্রোভাইডার-অজ্ঞাস্টিক হওয়া খুবই গুরুত্বপূর্ণ।
- আউট-অফ-দ্য-বক্স LSP সাপোর্ট
- TUI এর উপর ফোকাস। bhaiagi নিওভিম (neovim) ব্যবহারকারী এবং [terminal.shop](https://terminal.shop) এর নির্মাতাদের দ্বারা তৈরি; আমরা টার্মিনালে কী কী সম্ভব তার সীমাবদ্ধতা ছাড়িয়ে যাওয়ার চেষ্টা করছি।
- ক্লায়েন্ট/সার্ভার আর্কিটেকচার। এটি যেমন bhaiagi কে আপনার কম্পিউটারে চালানোর সুযোগ দেয়, তেমনি আপনি মোবাইল অ্যাপ থেকে রিমোটলি এটি নিয়ন্ত্রণ করতে পারবেন, অর্থাৎ TUI ফ্রন্টএন্ড কেবল সম্ভাব্য ক্লায়েন্টগুলোর মধ্যে একটি।

---

**আমাদের কমিউনিটিতে যুক্ত হোন** [Discord](https://discord.gg/bhaiagi) | [X.com](https://x.com/bhaiagi)
